...
func (p *ConditionalPrinter) Println(a ...any) (n int, err error) {
	if p.print {
...
func (p *ConditionalPrinter) Print(a ...any) (n int, err error) {
	if p.print {
...
func (p *ConditionalPrinter) Printf(format string, a ...any) (n int, err error) {
	if p.print {
